...
if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) {
	...
	<strong>Sorry this email address is already exist.</strong>
	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
	</button>
</div>';
	...
	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		...
		if (isset($name) && isset($blood_group) && isset($gender) && isset($day) && isset($month) && isset($year) && isset($email) && isset($contact) && isset($city)) {
			...
			if (mysqli_query($connection, $sql)) {
				$updatedSuccess = '<div class="alert alert-success alert-dismissible fade show" role="alert">
...
?>
	...
	<strong>Passwords are not match.</strong>
	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
	</button>
	</div>';
					...
					$passwordError = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
	<strong>The password minimum contains of 8 characters.</strong>
	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
	</button>
	</div>';
		...
		<div class="row">
			...
			<div class=" card col-md-6 offset-md-3">
				<div class="panel panel-default" style="padding: 20px;">
					...
					if (isset($updatedSuccess)) echo $updatedSuccess;
					?>
					...
					<form class="form-group" action="" method="post">
						...
						<div class="form-inline">
							...
							<select class="form-control demo-default" id="date" name="day" style="margin-bottom:10px;" required>
								...
								<?php if (isset($date['2'])) echo '<option selected="" value="' . $date['1'] . '">' . $date['0'] . '</option>'; ?>
						...
						<div class="form-group">
							...
							<select name="city" id="city" class="form-control demo-default" required>
								...
								<optgroup title="Azad Jammu and Kashmir (Azad Kashmir)" label="&raquo; DHAKA"></optgroup>
								<option value="Bagh">Dhanmondi</option>
								<option value="Bhimber">Sukrabad</option>
								<option value="Kotli">Kolabagan</option>
								<option value="Mirpur">Mirpur</option>
								<option value="Muzaffarabad">Jattrabari</option>
								<option value="Neelum">Kollanpur</option>
								<option value="Poonch">Gulshan</option>
								<option value="Sudhnati">Dhamrai</option>
								<optgroup title="Balochistan" label="&raquo; BARISHAL"></optgroup>
								<option value="Awaran">Kaukhali</option>
								<option value="Barkhan">Pirojpur</option>
								<option value="Bolan">Banuripara</option>
			...
			<div class="card col-md-6 offset-md-3">
				<div class="panel panel-default" style="padding: 20px;">
					...
					<form action="" method="post" class="form-group form-container">
						...
						if (isset($updatedPasswordSuccess)) echo $updatedPasswordSuccess;
						?>
